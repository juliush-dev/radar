<div class="relative">
    <input
        class="block w-full sm:pl-9 text-sm shadow-sm focus:ring-fuchsia-500 focus:border-fuchsia-500 border-fuchsia-500"
    ...
    <div class="absolute inset-y-0 left-0 pl-3 hidden sm:flex items-center pointer-events-none">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-fuchsia-600" viewBox="0 0 20 20"
            fill="currentColor">

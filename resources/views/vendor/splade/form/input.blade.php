        ...
        <div class="flex rounded-md shadow-sm">
            ...
            <input
                {{ $attributes->except(['v-if', 'v-show', 'v-for', 'class'])->class([
                        'bg-slate-300 block w-full border-0 focus:border-teal-200 focus:bg-teal-900 focus:ring focus:ring-teal-200 focus:ring-opacity-50 disabled:opacity-50 disabled:bg-gray-50 disabled:cursor-not-allowed',

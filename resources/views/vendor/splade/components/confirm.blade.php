                            ...
                            <x-splade-component is="dialog" panel
                                ...
                                <div class="sm:flex sm:items-start">
                                    <div class="text-center sm:mt-0 sm:text-left">
                                        ...
                                        <div class="mt-2" v-if="confirm.text">
                                            <p class="text-sm text-green-500" v-text="confirm.text" />
                                        </div>
                                        ...
                                        <div class="mt-2 flex rounded-md border border-teal-500 shadow-sm"
                                            ...
                                            <input type="password" name="password" placeholder="Password"
                                                ...
                                                class="rounded-md block w-full border-0 focus:border-teal-500 focus:ring focus:ring-emerald-200 focus:ring-opacity-50 disabled:opacity-50 disabled:bg-green-50 disabled:cursor-not-allowed"
                                ...
                                <div class="mt-5 sm:mt-4 sm:flex">
                                    <button dusk="splade-confirm-confirm" type="button"
                                        ...
                                        :class="{
                                            'bg-green-500 hover:bg-green-700 focus:ring-emerald-500': !confirm
                                                .confirmDanger,
                                    ...
                                    <button dusk="splade-confirm-cancel" type="button"
                                        class="mt-3 w-full inline-flex justify-center rounded-md border border-teal-500 px-4 py-2 bg-white text-base font-medium text-green-700 shadow-sm hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"

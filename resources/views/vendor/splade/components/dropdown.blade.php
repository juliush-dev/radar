<SpladeDropdown
    {{ $attributes->except('class')->mergeVueBinding(':inline', $inline)->mergeVueBinding(':teleport', $teleport)->mergeVueBinding(':close-on-click', $closeOnClick) }}
    ...
    <template #button="dropdown">
        <button type="button" aria-haspopup="true"
            ...
            :class="{ 'cursor-not-allowed': dropdown.disabled }" :disabled="dropdown.disabled"

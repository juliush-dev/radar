<x-layouts.app>
    <x-splade-modal close-explicitly class="shadow-md p-6 max-w-md mx-auto">
        ...
        <x-splade-form method="patch" :action="route('contributions.subjects.update', $subject)" :default="[
            'title' => $subject->contribution->title,
            'description' => $subject->description,
            'year_levels_covered_by_it' => explode(',', $subject->year_levels_covered_by_it),
            ...
            <x-splade-select class="text-slate-800" label="Years" name="year_levels_covered_by_it" :options="$yearsOptions"
                multiple />

    ...
    <x-splade-modal>
        <div class="bg-slate-800 p-6 min-h-screen shadow-md shadow-amber-500">
            ...
            <x-splade-form action="{{ route('contribution.skill.store') }}" class="flex flex-col gap-8">
                ...
                <x-splade-select label="Years of the training covering it" name="years_levels_covering_it"
                    :options="$yearsLevelsOptions" multiple />
                ...
                <x-splade-select label="Fields of the training covered by it" name="fields_covered_by_it"
                    :options="$topicFieldsOptions" multiple />

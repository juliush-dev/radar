<x-layouts.app>
    <x-layouts.contributions type="topic" label="topics" action-label="Submit a new topic"
        ...
        <x-layouts.navigation-link open-as="modal" type="call-to-action" resource="contribution.topic" action="create"
                ...
                <x-slot name="body">
                    @foreach ($component->for->resource as $r)
                        <tr class="border-b border-emerald-900">
                            ...
                            <td class="p-6">{{ $r->year_teached_at }}</td>
                            ...
                            <td class="p-6">
                                @if ($r->subjectCoveringIt)
                                    <x-splade-dropdown>
                                        ...
                                        <div
                                            class="whitespace-nowrap shadow bg-slate-100/80 p-2 rounded flex flex-col gap-4">
                                            <x-layouts.navigation-link open-as='modal' resource="topic-subject"
                                ...
                                @else
                                    <x-layouts.navigation-link open-as="modal" type="call-to-action"

<x-layouts.app>
    <x-layouts.contributions label="Contributions"
        ...
        <div class="flex flex-col gap-6 h-full overflow-hidden">
            <div class="flex gap-6 w-full overflow-x-auto">
                <x-contribution-dashboard-card open-as="modal" label="field(s)" type="fields" :total="$contributedField"
                    :published="$contributedFieldPublished" :approved="$contributedFieldApproved" :pending="$contributedFieldPending" />
                <x-contribution-dashboard-card open-as="modal" label="group(s)" type="groups" :total="$contributedGroup"
                    :published="$contributedGroupPublished" :approved="$contributedGroupApproved" :pending="$contributedGroupPending" />
                <x-contribution-dashboard-card open-as="modal" label="subject(s)" type="subjects" :total="$contributedSubjects"

    ...
    <x-layouts.contributions type="contribution" label="Contributions"
        ...
        <div class="flex flex-col gap-6">
            <div class="flex gap-6">
                <x-contribution-dashboard-card label="skill(s)" type="skill" :total="$contributedSkills" :published="$contributedSkillsPublished"
                    :approved="$contributedSkillsApproved" :pending="$contributedSkillsPending" />
                <x-contribution-dashboard-card label="subject(s)" type="subject" :total="$contributedSubjects" :published="$contributedSubjectsPublished"
                    :approved="$contributedSubjectsApproved" :pending="$contributedSubjectsPending" />
                <x-contribution-dashboard-card label="topic(s)" type="topic" :total="$contributedTopics" :published="$contributedTopicsPublished"
                    :approved="$contributedTopicsApproved" :pending="$contributedTopicsPending" />
                <x-contribution-dashboard-card label="learning material(s)" type="learning-material" :total="$contributedLearningMaterials"

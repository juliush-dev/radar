<x-layouts.app>
    <div class="flex flex-col gap-8 h-full">
        ...
        <div class="grid grid-cols-2 gap-8">
            <x-layouts.contribution-dashboard-card label="skill(s)" type="skill" :total="$contributedSkills" :published="$contributedSkillsPublished"
                :approved="$contributedSkillsApproved" :pending="$contributedSkillsPending" />
            <x-layouts.contribution-dashboard-card label="subject(s)" type="subject" :total="$contributedSubjects" :published="$contributedSubjectsPublished"
                :approved="$contributedSubjectsApproved" :pending="$contributedSubjectsPending" />
            <x-layouts.contribution-dashboard-card label="topic(s)" type="topic" :total="$contributedTopics" :published="$contributedTopicsPublished"

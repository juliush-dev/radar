        ...
        <div class="flex flex-col gap-8 h-full">
            ...
            @if (
                $contributedSkills->for()->count() == 0 &&
                    $contributedTeachers->for()->count() == 0 &&
                    $contributedSubjects->for()->count() == 0 &&
                    $contributedKnowledge->for()->count() == 0 &&
                    $contributedLearningMaterials->for()->count() == 0)
            ...
            <div class="flex flex-col gap-10 h-full overflow-auto pb-8 pr-5">
                <div>
                    ...
                    <x-splade-table :for="$contributedSkills::class" pagination-scroll="head" />
                </div>
                <div>
                    <x-splade-table :for="$contributedTeachers::class" pagination-scroll="head" />
                </div>
                <div>
                    <x-splade-table :for="$contributedSubjects::class" pagination-scroll="head" />
                </div>
            </div>
        </div>
    </div>

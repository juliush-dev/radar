    ...
    <div class="p-6">
        ...
        @if (!Agent::isPhone())
            <div
                ...
                <div
                    class="flex flex-col px-6 pb-6 pt-8 gap-4 w-full soft sticky top-0 bg-slate-100/90 dark:bg-slate-950/90 z-10 border-b border-slate-400/10">
                ...
                <x-splade-form method="get" action="{{ route('notes.modal') }}" stay background submit-on-change
                    class="w-full flex flex-col pt-6 gap-10 flex-1 px-6 pb-6 rounded-md text-zinc-400 dark:text-zinc-400/30">

<x-layouts.app
    ...
    <x-slot:leftSide>
        <div class="w-full h-full border-r border-slate-400/10">
            <div class="w-full max-h-[100%] pb-20 overflow-y-auto">
    ...
    <x-slot:rightSide>
        <div class="w-full h-full border-l border-slate-400/10">
            ...
            <x-note.last-opened :$lastOpened class="p-6 h-[66%] overflow-y-auto pb-20" />
        </div>
    </x-slot>
</x-layouts.app>

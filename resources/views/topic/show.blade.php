<x-layouts.app>
    <div id="topic" class="flex h-full p-10 text-white overflow-hidden">
        <main
            class=" backdrop-blur relative min-w-[500px] h-full flex flex-col bg-gradient-to-br from-blue-400/80  to-sky-500/90 justify-center">
            ...
            @endif
            <p class="font-mono break-all p-2 uppercase text-center text-5xl">
                {{ $topic->title }}
            </p>
            @if ($topic->subject)

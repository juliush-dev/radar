...
<x-splade-form action="{{ route('notes.filter') }}" method="get" :default="[
    ...
    class="hidden lg:block lg:flex-col lg:fixed lg:left-0 lg:w-[18rem] lg:border-r border-slate-400/30 lg:px-6 py-2 lg:top-7 lg:bottom-0 lg:pt-14 lg:overflow-y-auto lg:pb-4">

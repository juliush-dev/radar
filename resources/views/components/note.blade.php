<div
    class="mx-auto w-full overflow-hidden flex justify-center note md:border-2 border-slate-300 dark:border-slate-700/60 rounded-lg mb-6 transition-all duration-300">

        ...
        <div class="rounded p-4 border bg-slate-100 lg:p-6 mb-10 shadow shadow-slate-400 w-full relative transition-all duration-300"
            ...
            <div class="flex items-center gap-8">
                <div class="flex items-center gap-6 bg-inherit w-fit overflow-hidden">
                    <x-utils.reorder-trigger showCancel="knowledgeCube.reordering"
                        onCancel="knowledgeCube.toggleReorder(index)"
                        showReference="knowledgeCube.reordering && knowledgeCube.reorder.index != index && knowledgeCube.reorder.position != null"
                        onReference="knowledgeCube.setReorderingReference(index)"
                        position="knowledgeCube.reorder.position"
                        showReorderPosition="knowledgeCube.reorder.position == null"
                        onReorderBefore="knowledgeCube.setReorderingBefore(index)"
                        onReorderAfter="knowledgeCube.setReorderingAfter(index)" />
                </div>

@php($years = $rq->years())
<div class="sticky right-0 overflow-x-auto top-0 z-10 flex bg-inherit backdrop-blur gap-0 w-full flex-wrap shadow mb-4">
...
<div class="w-full flex flex-col bg-inherit border border-slate-200 dark:border-slate-700 p-8">

 <div
     class="transition-all group bg-white dark:bg-slate-700 dark:border-slate-700 border-slate-300 flex flex-col gap-3 justify-between p-6 rounded-md whitespace-break-spaces border">

   <div
       class="shadow group relative backdrop-blur-md w-[350px] text-teal-900 overflow-hidden topic min-h-[475px] gap-0 transition-all duration-100 items-center justify-center hover:border-slate-300 rounded-xl border border-slate-200">
       <div
           class="group-hover:bg-teal-400 backdrop-blur-md bg-teal-400/40 flex flex-col gap-10 justify-center items-center p-6 pt-8 transition-all duration-500">
           <div class="flex gap-2">
                       ...
                       <x-splade-form :action="route('topics.assess', $topic)" :default="['assessment' => $i]">
                           <button type="submit">
                               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                   stroke="currentColor"
                                   class="w-6 h-6 text-slate-500 group-hover:text-teal-700 transition-all duration-300 {{ isset($topicAssessment) && isset($topicAssessment->assessment) && $i <= $topicAssessment->assessment ? 'fill-teal-700 text-teal-700 group-hover:fill-teal-600 group-hover:text-teal-600' : '' }}">
               ...
               @else
                   @for ($i = 1; $i <= 5; $i++)
                       ...
                       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                           stroke="currentColor"
                           class="w-6 h-6 text-slate-500 group-hover:text-teal-700 transition-all duration-300">
                           <path stroke-linecap="round" stroke-linejoin="round"
                               d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                       </svg>
                       </Link>
       ...
       <div
           class="bg-slate-200 overflow-y-auto opacity-70 group-hover:opacity-100  gap-4 justify-center items-center transition-all duration-700">
           <section class="p-6">
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
               ...
               <h1 class="text-teal-900 text-center mb-2 text-lg">
           ...
           <section class="bg-sky-400/10 p-6">
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                   stroke="currentColor" class="w-6 h-6 mx-auto mb-2">
                   <path stroke-linecap="round" stroke-linejoin="round"

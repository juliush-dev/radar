 <div
     class="group rounded-md border-2 border-violet-300 text-white shadow shadow-violet-400/80 dark:shadow-violet-400/50 hover:shadow-md hover:shadow-violet-400/60  flex flex-col gap-0 p-6 transition-all duration-300">
         ...
         @auth
             <div class="flex gap-6 items-center">
                 ...
                 @can('update-topic', $topic)
                     @if (!$topic->is_update || $topic->potentialReplacement == null)
                         <x-layouts.navigation-link class="text-blue-400" resource="topics" action="edit" :action-args="$topic">
                             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                 stroke="currentColor"
                 ...
                 @can('delete-topic', $topic)
                     <x-layouts.navigation-link class="text-red-400" resource="topics" action="destroy" :action-args="$topic">
                         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor"

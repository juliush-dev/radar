 ...
 @endguest
 <div class="bg-inherit py-2 l:gpy-1 sticky top-0 z-20 flex flex-wrap lg:flex-nowrap items-center gap-0 md:gap-0 justify-between w-full  text-slate-800 dark:text-white border-b border-slate-300/50 dark:border-slate-700/50 overflow-x-auto lg:overflow-hidden"
     ...
     <div class="lg:w-[980px] mx-6 text-base flex justify-evenly gap-6 items-center transition-all duration-200 lg:overflow-x-auto lg:mx-auto"
         ...
         @endauth
         <x-authentication />
         <button @click="radar.dark = !radar.dark" class="mt-0.5 whitespace-nowrap">
             <svg v-if="!radar.dark" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                 stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-inherit">
                 <path stroke-linecap="round" stroke-linejoin="round"
                     d="M21.752 15.002A9.72 9.72 0 0 1 18 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 0 0 3 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 0 0 9.002-5.998Z" />
             </svg>
             <svg v-if="radar.dark" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                 stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-slate-400/40">
                 <path stroke-linecap="round" stroke-linejoin="round"

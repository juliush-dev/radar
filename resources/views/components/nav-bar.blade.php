 ...
 <div v-show="radar.navigation"
     class="bg-inherit @if (Agent::isAndroidOs() || Agent::isEdge()) pt-2 @endif sticky top-0 z-20 flex flex-wrap lg:flex-nowrap items-center gap-0 md:gap-0 justify-between w-full  text-slate-800 dark:text-white border-b border-slate-300/50 dark:border-slate-700/50 overflow-x-auto lg:overflow-hidden"

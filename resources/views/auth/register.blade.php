<x-layouts.app
    ...
    <x-auth-card>
        <div class="font-medium text-xl mb-8 capitalize  text-center">Contributor registration form</div>
        <x-splade-form action="{{ route('register') }}" class="space-y-4">
            ...
            <div class="flex items-center justify-end gap-5">
                <x-authentication />
                <x-splade-submit class="bg-cyan-500 hover:bg-cyan-600 shadow-md" :label="__('Register')" />
            </div>
        </x-splade-form>
    </x-auth-card>
</x-layouts.app>

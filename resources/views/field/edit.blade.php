<x-layouts.app active-page="Edit Field"
    ...
    <div class="relative h-full overflow-y-auto px-6 lg:px-80 md:px-60 pb-6">
        ...
        <div class="w-full flex flex-col bg-white p-8">
            <x-splade-form :action="route('fields.update', $field)" method="patch" :default="[
                'title' => $field->title,
                'code' => $field->code,
                ...
                <div class="flex justify-between my-6 gap-6">
                    ...
                    <Link href="{{ route('fields.show', $field) }}"
                        class="flex whitespace-nowrap items-center justify-center w-fit px-4 rounded-none text-white bg-slate-400 shadow hover:bg-slate-500 hover:shadow-md align-middle">
                    Cancel changes
                    </Link>
                </div>
            </x-splade-form>

<x-layouts.app active-page="Edit Subject"
    ...
    <x-splade-modal>
        <div class="bg-white relative w-full overflow-y-auto p-8 rounded-md">
            <x-splade-form :action="route('subjects.update', $subject)" method="patch" :default="[
                'title' => $subject->title,
                ...
                <button type="submit"
                    class="w-full py-2 px-4 bg-fuchsia-400 text-white hover:bg-fuchsia-500 shadow-md rounded-md">
                    Save changes
                </button>
            </x-splade-form>
        </div>

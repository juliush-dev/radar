<template>
    <div id="menu"
        ...
        <div class="flex items-center">
            <button class="w-fit" @click.prevent="editor.setEditable(!editor.isEditable)">
                <svg v-if="editor.isEditable" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
